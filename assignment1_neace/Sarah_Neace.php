<html lang="en">
	...
	<body>
		...
		<title><?php echo 'Sarah Neace'; ?></title>
		<div class="container text-center mb-5">
			<h1><?php echo 'Sarah Neace'; ?> </h1>
		</div>
		<div class="container">
    <div class="row">
      <div class="col-lg-5 col-md-6">
        <div class="mb-2">
          <img class="w-100" src="photoOfMe.jpeg" alt="">
        </div>
        <div class="mb-2 d-flex">
          <h4 class="font-weight-normal"> <?php echo 'Sarah Neace'; ?> </h4>
        ...
        <div class="mb-2">
          <ul class="list-unstyled">
            ...
            <li class="media">
              ...
              <label class="media-body"> <?php echo 'neaces3@mymail.nku.edu'; ?> </label>
            </li>
          </ul>
        </div>
      </div>
      <div class="col-lg-7 col-md-6 pl-xl-3">
        ...
        <p> <?php echo 'I am a very hard worker, very organised, and love working in teams. These are just a few characteristics about me that make me a great asset to any team.' ?> </p>
        <div class="my-2 bg-light p-2">
          <p class="font-italic mb-0"> <?php echo 'Always looking to learn more!'; ?> </p>
        </div>
        ...
        <div class="py-1">
          <div class="progress">
            <div class="progress-bar" role="progressbar" style="width:70%" aria-valuenow="70" aria-valuemin="0" aria-valuemax="100">
              <div class="progress-bar-title"> <?php echo 'CSS'; echo "<br>"; ?> </div>
